...
- Para cuotas: completar cuotas_total y cuota_numero SOLO cuando el resumen indica explícitamente que es una compra financiada en cuotas (aparece la palabra "cuota"/"cuotas", o un formato tipo "03/12" pegado a una compra puntual, ej. "NETFLIX 03/12"). Si no hay ninguna señal de eso, dejar cuotas_total: 1, cuota_numero: 1.
  ...
  Formato AMEX "Facturación acelerada de NN cuotas" / "Primer cuota facturada MM/AA": el "MM/AA" ahí es el mes/año en que se facturó la primera cuota, NO un "cuota MM de AA" — el total de cuotas es el número NN ("de 04 cuotas" = cuotas_total: 4), y el número de cuota es el que corresponde a cuántos meses pasaron desde MM/AA hasta el mes de este resumen (si "Primer cuota facturada 04/26" y este resumen factura en 06/26, van 3 cuotas facturadas → cuota_numero: 3). Esta línea y la siguiente ("Primer cuota facturada...") son parte de LA MISMA transacción que el comercio de la línea de arriba (ej. "MERPAGO*LPBS") — nunca generes una transacción aparte llamada "Cuota" o similar a partir de estas líneas descriptivas.
